/**
 * @file        Extensions to the native string prototype.
 * @module      util/string
...
if(!String.prototype.tabsToSpaces) {
    Object.defineProperty(String.prototype, 'tabsToSpaces',
    {
        /**
         ...
         */
        value: function(spaceNum = 2)
        {
            let spaces = ' '.repeat(spaceNum);
            const reg = new RegExp('\t', 'g')
            return this.replace(reg, spaces);
        },
        enumerable: false
    });
}
...
if(!String.prototype.countWords) {
    Object.defineProperty(String.prototype, 'countWords',
    {
        /**
        ...
        value: function()
        {
            let s = this.replace(/(^\s*)|(\s*$)/gi,"");    // Exclude  start and end white-space.
...
if(!String.prototype.ucwords) {
    Object.defineProperty(String.prototype, 'ucwords',
    {
        ...
        value: function()
        {
            let ret = this.replace(/^[\u00C0-\u1FFF\u2C00-\uD7FF\w]|\s[\u00C0-\u1FFF\u2C00-\uD7FF\w]/g, 
                function(letter) {
...
if(!String.prototype.replaceAll) {
    Object.defineProperty(String.prototype, 'replaceAll',
    {
         ...
         * @return  {string}            Processed string.
         */
        value: function(search, rep)
        {
            return this.split(search).join(rep);
        },
        enumerable: false
    });
}
...
if(!String.prototype.slugify) {
    Object.defineProperty(String.prototype, 'slugify',
    {
         ...
         */
        value: function(opts = {replacement: '-', lower: true, strict: true})
        {
...
if(!String.prototype.deslugify) {
    Object.defineProperty(String.prototype, 'deslugify',
    {
        /**
         * Deslugify string.
         * 
...
if(!String.prototype.truncate) {
    Object.defineProperty(String.prototype, 'truncate',
    {
        ...
        {
            return this.split(" ").splice(0, words).join(" ");
        },
        enumerable: false
    });
}
